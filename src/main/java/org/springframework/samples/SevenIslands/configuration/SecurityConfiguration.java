...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				//.antMatchers("/games/rooms").hasAnyAuthority("players","admin")
				.antMatchers("/players/playerAdmins/**").hasAnyAuthority("admin")
				.antMatchers("/players/player/**").hasAnyAuthority("player")
				.antMatchers("/achievements/achievementsPlayers/**").hasAnyAuthority("player","admin")
                .antMatchers("/achievements/achievementsAdmins/**").hasAnyAuthority("admin")
				.antMatchers("/games/**").permitAll()
