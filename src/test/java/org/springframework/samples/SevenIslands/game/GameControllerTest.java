...
import org.springframework.samples.SevenIslands.*;
...
class GameControllerTests {
	...
	void setup() {
        ...
        game1.setName("nameOfGame");
        game1.setPrivacity(PRIVACITY.PRIVATE);
		given(this.gameService.findGameById(TEST_GAME_ID).get()).willReturn(game1);
	...
	void testInitCreationForm() throws Exception {
		mockMvc.perform(get("/games/new")).andExpect(status().isOk()).andExpect(model().attributeExists("game"))
				.andExpect(view().name("games/editarJuego"));
	}
    
	@WithMockUser(value = "spring")
        @Test
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc.perform(post("/games/new").param("name", "nameOfGame2").param("code", "ZZZZ")
							.with(csrf())
							.param("privacity", "PUBLIC")) //no sé si dará problemas
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc.perform(post("/gamess/new")
							.with(csrf())
							.param("name", "nameOfGame2")
							.param("code", "ZZZZ"))
				.andExpect(status().isOk())
				.andExpect(model().attributeHasErrors("game"))
				.andExpect(model().attributeHasFieldErrors("game", "privacity"))
				.andExpect(view().name("games/editarJuego"));
	}*/
    /*
	@WithMockUser(value = "spring")
